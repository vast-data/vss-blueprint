...
Docker image: `your.registry/vde-video-batch-sync:v1` (placeholder — build and push from this directory; see [K8s deployment guide](../../deployments/vss-k8s-application/README.md#step-2-docker-images))
